...
def main():
    ...
    apis_to_test = [
        ...
        ("GET", "/api/training/session/current", None, "Sesión actual de entrenamiento", False),
    ...
    for i, (method, endpoint, data, description, needs_auth) in enumerate(apis_to_test, 1):
