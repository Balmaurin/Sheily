...
def test_llm_direct():
    ...
    try:
        ...
        if response.status_code == 200:
            ...
            is_fallback = any(indicator in llm_response.lower() for indicator in fallback_indicators)
    ...
    try:
        ...
        for i, message in enumerate(test_messages, 1):
            ...
            if response.status_code == 200:
                ...
                elif any(word in ai_response.lower() for word in ["error", "lo siento", "no puedo"]):
