...
def test_orchestrator_api():
    ...
    try:
        ...
        if response.status_code == 200:
            ...
            print(f"📊 Estado: {health_data.get('data', {}).get('orchestrator_status')}")
        else:
        ...
        if response.status_code == 200:
            ...
            print(f"📄 Respuesta: {query_data.get('data', {}).get('text', '')[:100]}...")
        else:
        ...
        print("💡 Asegúrate de que el servidor backend esté ejecutándose en puerto 8000")
        return False
    except Exception as e:
