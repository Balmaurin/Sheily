...
DOMAIN_CATEGORIES = [
    # Ciencias
    "Biología", "Física", "Química", "Astronomía", "Geología", "Ecología", 
    "Neurociencia", "Genética", "Paleontología", "Oceanografía",
    
    # Tecnología
    "Inteligencia Artificial", "Ciberseguridad", "Desarrollo Web", "Redes", 
    "Computación en la Nube", "Robótica", "Realidad Virtual", "Blockchain", 
    "Internet de las Cosas", "Computación Cuántica",
    
    # Humanidades y Sociales
    "Historia", "Filosofía", "Antropología", "Psicología", "Sociología", 
    "Arqueología", "Lingüística", "Estudios Culturales", "Ética", "Política",
    
    # Ramas adicionales para completar 32
    "Economía", "Artes Visuales"
]
...
def generate_datasets():
    ...
    models_path = "/home/yo/Escritorio/DEFINITIVO (Copiar 3)/shaili-ai/models/qwen_branches"
    ...
    for i, domain in enumerate(DOMAIN_CATEGORIES, 1):
        ...
        print(f"Dataset generado para rama {branch_name} ({BRANCH_NAMES[domain]}): {dataset_path}")
    
    # Guardar configuración de ramas
    config_path = "/home/yo/Escritorio/DEFINITIVO (Copiar 3)/shaili-ai/config/branch_config.json"
