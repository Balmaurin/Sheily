...
def create_test_data():
    ...
    test_data = {
        ...
        "dataset_data": {
            ...
            "content": [
                {"question": "¿Qué es Python?", "answer": "Python es un lenguaje de programación"},
...
def test_backup_manager():
    ...
    try:
        ...
        backup_id = backup_manager.create_backup(
            backup_type="test",
            description="Backup de prueba del sistema"
        )
...
def test_system_routes():
    ...
    try:
        ...
        print(f"✅ Estado del sistema: {status['total_commands_executed']} comandos ejecutados")
