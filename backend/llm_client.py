...
class LLMClient:
    ...
    def __init__(self, config: Dict[str, Any] = None):
        ...
        logger.info(f"🔧 Cliente LLM inicializado - Modo: {self.llm_mode}, URL: {self.llm_base_url}")
    
    def _make_request(self, endpoint: str, payload: Dict[str, Any], retries: int = None) -> Dict[str, Any]:
        """
    ...
    def llm_chat_openai(self, messages: List[Dict[str, str]], base_url: str = None, **kwargs) -> str:
        """
    ...
    def generate_draft(self, query: str, context: str = "") -> str:
        ...
        """
        messages = [
            {"role": "system", "content": "Eres SHEILY. Genera un borrador inicial de respuesta basado en la consulta del usuario."},
    ...
    def critique_response(self, draft: str, query: str) -> str:
        ...
        """
        messages = [
            {"role": "system", "content": "Eres SHEILY. Analiza críticamente el borrador de respuesta y identifica áreas de mejora."},
    ...
    def fix_response(self, draft: str, critique: str, query: str) -> str:
        ...
        """
        messages = [
            {"role": "system", "content": "Eres SHEILY. Mejora el borrador de respuesta basándote en el análisis crítico proporcionado."},
...
def llm_chat_openai(messages: List[Dict[str, str]], base_url: str = None, **kwargs) -> str:
...
if __name__ == "__main__":
    ...
    parser.add_argument('--mode', choices=['ollama', 'openai'], default='ollama', help='Modo del cliente')
    parser.add_argument('--url', default='http://localhost:11434', help='URL base del servicio')
