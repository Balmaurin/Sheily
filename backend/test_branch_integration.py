...
class BranchIntegrationTester:
    ...
    def test_chat_query(self, query: str, expected_domain: str = None) -> Dict:
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                print(f"   🎯 Dominio detectado: {domain} (confianza: {confidence:.2f})")
                ...
                if expected_domain and domain != expected_domain:
                    print(f"⚠️ Advertencia: Dominio esperado '{expected_domain}' pero detectado '{domain}'")
    ...
    def run_comprehensive_test(self):
        ...
        successful_tests = sum(1 for r in self.test_results if r["result"].get("success", False))
        ...
        for domain, stats in domain_stats.items():
            ...
            print(f"   {domain}: {stats['count']} consultas (confianza promedio: {avg_conf:.2f})")
