...
class TestModelEndpoints(unittest.TestCase):
    ...
    def test_model_health_check(self):
        ...
        self.assertIn('bartowski/Llama-3.2-3B-Instruct-GGUF', data['model_info']['name'], "Modelo incorrecto")
    ...
    def test_model_generation(self):
        ...
        self.assertEqual(data['model'], 'Llama-3.2-3B-Instruct-Q8_0', "Modelo incorrecto")
