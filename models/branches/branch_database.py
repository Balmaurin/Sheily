...
class BranchDatabase:
        ...
        default_branches = [
            {
                ...
                "parameters": {
                    "temperature": 0.3,
                    "max_tokens": 1024,
                    "focus_areas": ["python", "javascript", "algorithms", "data_structures"],
            ...
            },
            {
                ...
                "parameters": {
                    "temperature": 0.5,
                    "max_tokens": 1536,
                    "focus_areas": ["machine_learning", "neural_networks", "nlp", "computer_vision"],
            ...
            },
            {
                ...
                "parameters": {
                    "temperature": 0.2,
                    "max_tokens": 512,
                    "focus_areas": ["sql", "database_design", "optimization", "data_modeling"],
                    "expertise_level": "advanced"
                }
            },
            {
                ...
                "parameters": {
                    "temperature": 0.7,
                    "max_tokens": 1024,
                    "focus_areas": ["general_knowledge", "conversation", "problem_solving"],
    ...
    def create_branch(self, branch_id: str, name: str, domain: str, 
        ...
        try:
            ...
            with sqlite3.connect(self.db_path) as conn:
                conn.execute("""
                    ...
                    VALUES (?, ?, ?, ?, ?, ?, ?, ?)
                """, (
                    branch_id, name, domain, description,
                    json.dumps(parameters), now, now, True
                ))
                conn.commit()
    ...
    def get_usage_stats(self, branch_id: str, days: int = 7) -> Dict[str, Any]:
        ...
        try:
            ...
            with sqlite3.connect(self.db_path) as conn:
                ...
                """, (branch_id, cutoff_date.isoformat())).fetchone()[0]
            ...
            self.logger.error(f"❌ Error obteniendo estadísticas de rama {branch_id}: {e}")
            return {
                "branch_id": branch_id,
                "error": str(e)
            }
    ...
    def get_system_info(self) -> Dict[str, Any]:
        ...
        try:
            with sqlite3.connect(self.db_path) as conn:
                ...
                total_branches = cursor.execute("SELECT COUNT(*) FROM branches").fetchone()[0]
                active_branches = cursor.execute("SELECT COUNT(*) FROM branches WHERE is_active = 1").fetchone()[0]
                total_usage_records = cursor.execute("SELECT COUNT(*) FROM branch_usage").fetchone()[0]
