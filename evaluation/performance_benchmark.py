...
from modules.src.advanced_clustering.semantic_clustering import AdvancedSemanticClustering
from modules.src.advanced_clustering.domain_adapter_optimizer import DomainAdapterOptimizer
...
class PerformanceBenchmark:
    ...
    def generate_test_data(self, num_texts: int = 100) -> List[str]:
        ...
        domains = [
            "medicina_y_salud", "tecnología", "ciencia", 
            "ingeniería", "computación_y_programación"
        ]
    ...
    def benchmark_domain_expansion(self, test_interactions: List[Dict]) -> Dict[str, Any]:
