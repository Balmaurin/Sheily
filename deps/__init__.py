...
from .dependencies_manager import DependenciesManager, get_dependencies_manager, DependencyInfo, DependencyStats
from .dependency_installer import DependencyInstaller, get_dependency_installer, InstallationResult, InstallationProgress
from .dependency_validator import DependencyValidator, get_dependency_validator, DependencyValidationResult, ValidationSummary
...
def validate_dependencies(dependencies_config: Dict[str, Any]) -> List[DependencyValidationResult]:
...
def install_all_dependencies(dependencies_config: Dict[str, Any]) -> List[InstallationResult]:
...
def validate_python_dependency(package_name: str, required_version: str) -> DependencyValidationResult:
    """Valida una dependencia específica de Python"""
    return dependency_validator.validate_python_dependency(package_name, required_version)

def validate_node_dependency(package_name: str, required_version: str) -> DependencyValidationResult:
...
def validate_system_dependency(package_name: str, required_version: str) -> DependencyValidationResult:
    """Valida una dependencia específica del sistema"""
    return dependency_validator.validate_system_dependency(package_name, required_version)
