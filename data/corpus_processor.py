...
class CorpusProcessor:
    ...
    def _initialize_tokenizers(self):
        ...
        try:
            ...
            self.tokenizers['embedding'] = AutoTokenizer.from_pretrained('sentence-transformers/all-MiniLM-L6-v2')
        ...
        try:
            ...
            self.tokenizers['generation'] = AutoTokenizer.from_pretrained('microsoft/Phi-3-mini-4k-instruct')
    ...
    def tokenize_text(self, text: str, language: str = 'es', 
    ...
    def extract_keywords(self, text: str, language: str = 'es', 
        ...
        try:
            ...
            keywords = sorted(filtered_freq.items(), key=lambda x: x[1], reverse=True)[:top_k]
    ...
    def process_document(self, document: Dict[str, Any]) -> ProcessedDocument:
        ...
        try:
            ...
            doc_id = document.get('id', hashlib.md5(document.get('content', '').encode()).hexdigest())
    ...
    def process_corpus(self, corpus_data: Dict[str, Any], 
                      save_processed: bool = True) -> Tuple[List[ProcessedDocument], CorpusStats]:
        ...
        try:
            ...
            logger.info(f"Corpus procesado exitosamente: {len(processed_docs)} documentos")
    ...
    def _calculate_corpus_stats(self, processed_docs: List[ProcessedDocument], 
                              start_time: datetime) -> CorpusStats:
    ...
    def _save_processed_corpus(self, processed_docs: List[ProcessedDocument], 
                             stats: CorpusStats):
    ...
    def create_vocabulary(self, processed_docs: List[ProcessedDocument], 
    ...
    def calculate_tf_idf(self, processed_docs: List[ProcessedDocument]) -> Dict[str, Dict[str, float]]:
...
if __name__ == "__main__":
    ...
    print(f"Documento procesado: {processed_doc.word_count} palabras, {processed_doc.sentence_count} oraciones")
