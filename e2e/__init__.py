...
from .e2e_test_manager import E2ETestManager, get_e2e_test_manager, TestResult, TestSuite, E2EConfig
from .test_generator import E2ETestGenerator, get_e2e_test_generator, TestCase, TestTemplate
...
def generate_custom_test(test_name: str, description: str, steps: List[Dict], 
                        template_name: str = "api_integration", variables: Dict[str, Any] = None) -> str:
    """Genera una prueba personalizada"""
    return e2e_test_generator.generate_custom_test(test_name, description, steps, template_name, variables)
