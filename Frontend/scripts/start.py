...
class FrontendStarter:
        ...
        try:
            ...
            if platform.system() == "Windows":
                ...
                if result.stdout.strip():
                    ...
                    print_warning(f"Encontrados procesos anteriores en puerto {self.port}: {pids}")
                    for pid in pids:
                        try:
    ...
    def check_system_dependencies(self) -> bool:
        ...
        if not shutil.which("node"):
            ...
            print_status("Por favor, instala Node.js 18 o superior desde https://nodejs.org/")
            return False
        ...
        try:
            ...
            if node_major < 18:
                print_error(f"Se requiere Node.js 18 o superior. Versión actual: {node_version}")
                return False
...
"""
    ...
    def check_node_dependencies(self) -> bool:
        ...
        try:
            result = subprocess.run(["npm", "ls", "--depth=0"], 
                                  capture_output=True, text=True, cwd=self.project_dir)
            if "UNMET DEPENDENCY" in result.stdout or "UNMET DEPENDENCY" in result.stderr:
    ...
    def check_nextjs_config(self) -> bool:
        ...
        try:
            ...
            subprocess.run(["npx", "tsc", "--noEmit", "--skipLibCheck"], 
