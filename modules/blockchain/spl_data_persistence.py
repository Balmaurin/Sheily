...
class SPLDataPersistence:
    ...
    def __init__(self, db_path: str = "shaili_ai/data/spl_database.db"):
        ...
        try:
            with self.lock:
                with self._get_connection() as conn:
                    ...
                    """, (user_id, token_mint, new_balance, now.isoformat(), user_id, token_mint))
    ...
    def update_transaction_status(self, transaction_id: str, status: str, 
                                ...
                                confirmation_status: Optional[str] = None) -> bool:
        ...
        try:
            with self.lock:
                with self._get_connection() as conn:
                    ...
                    """, (
                        status, signature, block_height, fee, 
                        slot, confirmation_status, now.isoformat(), transaction_id
                    ))
    ...
    def save_token_statistics(self, token_mint: str, total_supply: int, 
                            circulating_supply: int, burned_supply: int,
                            total_accounts: int, total_transactions: int) -> bool:
        ...
        try:
            with self.lock:
                with self._get_connection() as conn:
                    ...
                    """, (
                        token_mint, total_supply, circulating_supply, burned_supply,
                        total_accounts, total_transactions, now.isoformat()
                    ))
