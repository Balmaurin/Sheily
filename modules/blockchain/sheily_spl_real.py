...
class SheilySPLReal:
    ...
    def __init__(self, config_path: str = "shaili_ai/config/sheily_token_config.json"):
    ...
    def create_token_account(self, user_id: str) -> str:
        ...
        try:
            ...
            self.client.send_transaction(
                transaction,
                [self.authority_keypair, user_keypair]
            )
    ...
    def transfer_real_tokens(self, from_user: str, to_user: str, amount: int) -> RealSPLTransaction:
        ...
        try:
            ...
            if (self.client and from_account.associated_token_account and 
                to_account.associated_token_account):
                try:
