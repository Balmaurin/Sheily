...
class NeuroFusionIntegratedDemo:
    ...
    async def demonstrate_consolidation_benefits(self):
        ...
        logger.info(f"   - Reducción de complejidad: {len(self.systems)} sistemas vs {total_modules_consolidated} módulos")
        logger.info(f"   - Tasa de consolidación: {(total_modules_consolidated/len(self.systems)):.1f} módulos por sistema")
