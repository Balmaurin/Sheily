...
class MainOrchestrator:
    ...
    def _process_query_internal(self, query: str, user_context: Dict[str, Any] = None) -> Dict[str, Any]:
    ...
    def _generate_response(self, query: str, route_info: Dict[str, Any], user_context: Dict[str, Any] = None) -> Dict[str, Any]:
    ...
    def _generate_branch_response(self, query: str, route_info: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            response_text = llm_client.llm_chat(messages, temperature=0.2, max_tokens=512)
    ...
    def _generate_rag_response(self, query: str, route_info: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            if citations:
                ...
                # Generar respuesta usando el cliente LLM
                response_text = llm_client.llm_chat(messages, temperature=0.1, max_tokens=768)
    ...
    def _generate_core_response(self, query: str, route_info: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            # Generar respuesta usando el cliente LLM
            response_text = llm_client.llm_chat(messages, temperature=0.3, max_tokens=512)
    ...
    def _generate_enhanced_response(self, query: str, route_info: Dict[str, Any], use_pipeline: bool = False) -> Dict[str, Any]:
    ...
    def _post_process_response(self, response: Dict[str, Any], domain_info: Dict[str, Any], route_info: Dict[str, Any]) -> Dict[str, Any]:
    ...
    def _update_metrics(self, response: Dict[str, Any], response_time: float):
        ...
        self.metrics['route_distribution'][route_type] = self.metrics['route_distribution'].get(route_type, 0) + 1
    ...
    def optimize_system(self) -> Dict[str, Any]:
        ...
        try:
            ...
            if self.adapter_policy:
                optimization_results['adapter_cache'] = self.adapter_policy.optimize_cache()
    ...
    def _clean_response_cache(self):
        ...
        if expired_queries:
            self.logger.info(f"🧹 Caché limpiado: {len(expired_queries)} entradas expiradas")
