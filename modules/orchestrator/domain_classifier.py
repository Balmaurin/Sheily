...
class DomainClassifier:
    def __init__(
        ...
        self.domains = domains or [
            'Lengua y Lingüística', 'Matemáticas', 'Computación', 
            'Ciencia de Datos', 'Física', 'Química', 'Biología', 
            'Medicina', 'Neurociencia', 'Ingeniería', 'Electrónica', 
            'Ciberseguridad', 'Sistemas', 'Ciencias de la Tierra', 
            'Astronomía', 'Economía', 'Empresa', 'Derecho', 
            'Sociología', 'Educación', 'Historia', 'Geografía', 
            'Arte', 'Literatura', 'Medios', 'Diseño', 
            'Deportes', 'Juegos', 'Hogar', 'Cocina', 
            'Viajes', 'Vida Diaria'
        ]
        ...
        self.semantic_model = AutoModel.from_pretrained('models/custom/shaili-personal-model')
