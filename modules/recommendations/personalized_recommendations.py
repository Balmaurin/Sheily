...
class PersonalizedRecommendations:
    ...
    def generate_user_profile(self, user_id: str) -> UserProfile:
        ...
        try:
            with sqlite3.connect(self.db_path) as conn:
                ...
                total_score = sum(row[3] for row in training_history if row[4])  # Solo respuestas correctas
                average_score = total_score / len(training_history) if training_history else 0
                ...
                preferred_difficulties = [diff for diff, count in difficulty_counts.most_common(2)]
    ...
    def get_exercise_recommendations(self, user_id: str, limit: int = 5) -> List[ExerciseRecommendation]:
        ...
        try:
            ...
            for exercise in available_exercises:
                confidence_score = self._calculate_recommendation_score(exercise, profile)
                ...
                if confidence_score > 0.3:  # Umbral mínimo
                    recommendation = ExerciseRecommendation(
                        ...
                        reasoning=self._generate_recommendation_reasoning(exercise, profile),
    ...
    def _calculate_recommendation_score(self, exercise, profile: UserProfile) -> float:
        ...
        if exercise.category in profile.preferred_categories:
            ...
            score += self.weights['category_preference'] * 0.8  # Priorizar áreas débiles
    ...
    def _save_recommendations(self, user_id: str, recommendations: List[ExerciseRecommendation]):
    ...
    def create_learning_path(self, user_id: str, target_skills: List[str] = None) -> LearningPath:
        ...
        try:
            ...
            estimated_duration = sum(ex.estimated_completion_time for ex in path_exercises) / 60  # horas
    ...
    def record_feedback(self, user_id: str, exercise_id: str, rating: int, 
                       feedback_text: str = None, completed: bool = False, 
    ...
    def get_user_insights(self, user_id: str) -> Dict[str, Any]:
        ...
        try:
            ...
            insights = {
                ...
                "recommendations": {
                    "next_exercises": [ex.exercise_id for ex in self.get_exercise_recommendations(user_id, 3)],
                    "suggested_learning_path": self.create_learning_path(user_id) is not None
                }
            }
