...
class IntegrationManager:
    ...
    def _calculate_confidence(self, processing_steps: List[Dict]) -> float:
        ...
        successful_steps = sum(1 for step in processing_steps if not step["result"].get("error"))
    ...
    def _log_interaction(self, original_query: str, adapted_query: str, routing_result: Dict):
