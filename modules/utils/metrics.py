...
class ShailiMetrics:
    def __init__(self, metrics_port: int = 8000, update_interval: float = 5.0):
        ...
        # Métricas de sistema
        self.system_metrics = {
            "cpu_usage": Gauge("shaili_cpu_usage_percent", "Uso de CPU del sistema"),
            "memory_usage": Gauge(
                "shaili_memory_usage_bytes", "Uso de memoria del sistema"
            ),
            "vram_usage": Gauge("shaili_vram_usage_bytes", "Uso de VRAM de GPU"),
        }

        # Métricas de modelo
        self.model_metrics = {
            "generation_latency": Gauge(
                "shaili_generation_latency_seconds", "Latencia de generación de texto"
            ),
            "tokens_generated": Counter(
                "shaili_tokens_generated_total", "Número total de tokens generados"
            ),
            ...
            "rag_hit_rate": Gauge(
                "shaili_rag_hit_rate", "Tasa de acierto de recuperación semántica"
            ),
        }
        ...
        self.memory_metrics = {
            ...
            "documents_indexed": Gauge(
                "shaili_documents_indexed", "Número de documentos indexados en RAG"
            ),
        }
