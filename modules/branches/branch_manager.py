...
class BranchManager:
    ...
    def _load_base_config(self):
        ...
        if self.base_config_path.exists():
            try:
                ...
                self.logger.info(f"📋 Configuración base cargada: {len(self.base_config.get('domains', []))} dominios")
    ...
    def create_branch(self, name: str, description: str, category: str,
                     keywords: List[str], model_name: str = "models/custom/shaili-personal-model",
                     config: Dict[str, Any] = None, metadata: Dict[str, Any] = None) -> str:
            ...
            try:
                ...
                with sqlite3.connect(self.db_path) as conn:
                    ...
                    """, (
                        ...
                        json.dumps(keywords), model_name,
                        json.dumps(default_config), json.dumps(metadata or {})
                    ))
    ...
    def list_branches(self, category: str = None, status: str = "active", limit: int = 100) -> List[Branch]:
    ...
    def update_branch(self, branch_id: str, updates: Dict[str, Any]) -> bool:
        ...
        with self._lock:
            try:
                ...
                allowed_fields = ['description', 'keywords', 'model_name', 'config', 'metadata']
                update_data = {}
    ...
    def export_branch(self, branch_id: str, export_path: str = None) -> str:
        ...
        try:
            ...
            export_file = export_dir / f"branch_{branch.name}_{datetime.now().strftime('%Y%m%d_%H%M%S')}.json"
