...
class EmbeddingPerformanceMonitor:
    ...
    def monitor_embedding_performance(self, text: str, model_name: str = "default") -> Dict[str, Any]:
        """
        ...
        try:
            ...
            self.logger.info(f"Embedding generado en {generation_time:.4f}s para texto de {len(text)} caracteres")
