...
class ResponseGenerator:
    ...
    def _continue_conversation(self, query: str, last_exchange: Dict[str, str]) -> str:
        ...
        if any(word in query.lower() for word in ["sí", "no", "correcto", "incorrecto"]):
    ...
    def _analyze_query_type(self, query: str) -> str:
        ...
        if any(word in query_lower for word in ["diferencias", "comparar", "vs", "versus"]):
    ...
    def _calculate_confidence(self, context: ResponseContext, response_type: str) -> float:
