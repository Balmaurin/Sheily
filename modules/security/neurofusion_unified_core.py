...
class PluginManager:
    ...
    def register_plugin(self, plugin_type: Type, plugin: PluginBase, category: Optional[str] = None):
        """
        Registrar un plugin
    ...
    def add_metric(self, name: str, value: float):
        ...
        if len(self.performance_history) > 10:
            ...
            if avg_performance < self.config.performance_threshold:
                ...
                self.logger.warning(f"Rendimiento del componente por debajo del umbral: {avg_performance}")
