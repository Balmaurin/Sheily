...
class SystemRoutes:
    ...
    def _register_commands(self) -> Dict[str, Dict[str, Any]]:
        ...
        commands = {
            ...
            "adapter_cache_store": {
                ...
                "parameters": ["adapter_id", "adapter_data", "model_name", "branch_name"]
            },
            "adapter_cache_get": {
                "module": "adapter_cache",
            ...
            "analysis_create": {
                ...
                "parameters": ["analysis_type", "model_name", "branch_name", "data", "metrics"]
            },
            "analysis_get": {
                "module": "analysis",
            ...
            "backup_create": {
                ...
                "parameters": ["backup_type", "custom_paths", "compression", "description"]
            },
            "backup_list": {
                "module": "backup",
            ...
            "branch_create": {
                ...
                "parameters": ["name", "description", "category", "keywords", "model_name", "config", "metadata"]
            },
            "branch_get": {
                "module": "branches",
                "function": "get_branch",
            ...
            "data_store": {
                ...
                "parameters": ["content", "data_type", "source", "embedding", "metadata"]
            },
            "data_get": {
                "module": "data",
                "function": "get_data",
            ...
            "data_store_embedding": {
                ...
                "parameters": ["content", "embedding", "model_type", "domain", "quality_score", "metadata"]
            },
            "data_store_interaction": {
                "module": "data",
                "function": "store_user_interaction",
                "description": "Almacenar interacción de usuario",
                "parameters": ["user_id", "session_id", "interaction_type", "content", "response", "duration_ms", "metadata"]
            },
            "data_stats": {
                "module": "data",
            ...
            "dataset_load": {
                ...
                "parameters": ["file_path", "name", "description", "target_dir", "metadata"]
            },
            "dataset_get": {
                "module": "datasets",
    ...
    def execute_command(self, command_name: str, **kwargs) -> Dict[str, Any]:
        ...
        try:
            ...
            if not hasattr(manager, function_name):
                raise ValueError(f"Función no encontrada: {function_name} en {module_name}")
    ...
    def get_system_status(self) -> Dict[str, Any]:
        ...
        status = {
            ...
            "successful_commands": len([c for c in self.command_history if c.status == "completed"]),
    ...
    def execute_batch_commands(self, commands: List[Dict[str, Any]]) -> List[Dict[str, Any]]:
    ...
    def search_commands(self, query: str) -> Dict[str, Dict[str, Any]]:
        ...
        for command_name, command_info in self.available_commands.items():
            if (query_lower in command_name.lower() or 
                query_lower in command_info["description"].lower() or
                query_lower in command_info["module"].lower()):
