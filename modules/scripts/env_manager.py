...
def main():
    ...
    parser.add_argument('--generate-secrets', action='store_true', help='Generar claves secretas')
    parser.add_argument('--validate', action='store_true', help='Validar configuración')
    parser.add_argument('--export', choices=['json', 'env'], help='Exportar configuración')
    parser.add_argument('--set', nargs=2, metavar=('KEY', 'VALUE'), help='Establecer variable de entorno')
